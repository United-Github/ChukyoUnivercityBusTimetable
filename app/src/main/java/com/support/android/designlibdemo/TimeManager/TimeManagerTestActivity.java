...
public class TimeManagerTestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            int[] nt = timeManager.nearBusTime(4, 1, 6, 53, TimeManager.DEPART_JOSUI);
            ...
            TimeManager.ScheduleMonth ms = timeManager.getMonthSchedule(4);
            TextView testText=(TextView)findViewById(R.id.ttmt);
            testText.setText(nt[0]+" "+nt[1]+"+"+bt[0]+" "+bt[1]+"+"+at[0]+" "+at[1]+"\n+"+bs.get(0).minutesList.get(0).minutes+"+"+ms.days.get(0));
